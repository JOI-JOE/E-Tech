                                ...
                                @if($brands->isNotEmpty())
                                    @foreach($brands as $brand)
                                        <div class="form-check mb-2">
                                            <input {{(in_array($brand->id,$brandsArray)) ? 'checked' : ''}} class="form-check-input brand-label" type="checkbox"  name="brands[]" value="{{$brand->id}}" id="brand-{{$brand->id}}">
                    ...
                    <div class="col-md-9">
                        <div class="row pb-3">
                                ...
                                <div class="d-flex align-items-center justify-content-end mb-4">
                                    <div class="ml-2">
                                        <select name="sort" id="sort" class="form-control">
                                            <option value="latest" {{($sort == 'latest') ? 'selected' : ''}}>Laste</option>
                            ...
                            <div class="col-md-12 pt-5">
                                {{-- là một phương thức trong Laravel được sử dụng để giữ nguyên các tham số query string (các phần sau dấu ? trong URL) khi tạo các liên kết phân trang.--}}
