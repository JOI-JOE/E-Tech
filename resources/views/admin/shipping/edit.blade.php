...
@section('customJs')
    <script>
        $("#shippingForm").submit(function (event) {
            ...
            $.ajax({
                url: '{{ route('shipping.update',$shippingCharge->id) }}', // Replace with your route
                type: 'put',
                ...
                success: function (response) {
                    ...
                    if(response['status'] == true){
                        ...
                        if(errors['amount']){
                            $('#amount').addClass('is-invalid').siblings('p').addClass('invalid-feedback').html(errors['country']);
                        }else{
