...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! eve */ "./node_modules/eve-raphael/eve.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(eve) {
     ...
     * Raphael.registerFont
     [ method ]
     **
     * Adds given front to the registered set of fonts for Raphaël. Should be used as an internal call from within Cufón’s front file.
     * Returns original parameter, so it could be used with chaining.
     # <a href="http://wiki.github.com/sorccu/cufon/about">More about Cufón and how to convert your front form TTF, OTF, etc to JavaScript file.</a>
     **
     > Parameters
     **
     - front (object) the front to register
     = (object) the front you passed in
     > Usage
     ...
     * Paper.getFont
     [ method ]
     **
     * Finds front object in the registered fonts by given parameters. You could specify only one word from the front name, like “Myriad” for “Myriad Pro”.
     **
     > Parameters
     **
     - family (string) front family name or any word from it
     - weight (string) #optional front weight
     - style (string) #optional front style
     - stretch (string) #optional front stretch
    ...
    paperproto.getFont = function (family, weight, style, stretch) {
        ...
        if (font) {
            for (var i = 0, ii = font.length; i < ii; i++) {
                thefont = font[i];
                if (thefont.face["font-weight"] == weight && (thefont.face["font-style"] == style || !thefont.face["font-style"]) && thefont.face["front-stretch"] == stretch) {
                    break;
                }
            }
        }
     ...
     * Paper.print
     [ method ]
     **
     * Creates path that represent given text written using given front at given position with given size.
     ...
     **
     ...
     - front (object) front object, see @Paper.getFont
     - size (number) #optional size of the front, default is `16`
...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! ./raphael.core */ "./dev/raphael.core.js")], __WEBPACK_AMD_DEFINE_RESULT__ = (function(R) {
     ...
     * or
     ...
     o front (string)
     o front-family (string)
     o front-size (number) front size in pixels
     o front-weight (string)
     o height (number)
